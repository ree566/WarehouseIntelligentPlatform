...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" Runat="Server">
    <table>
        <tr>
            <td>開立時間</td><td>領取時間</td>
        </tr>
        <tr>
            <td>當天10點前</td><td>下午1點</td>
        </tr>
        <tr>
            <td>當天10點後14點前</td><td>當天17:30</td>
        </tr>
        <tr>
            <td>當天14點後17點前</td><td>隔日10點</td>
        </tr>
        <tr>
            <td>當天17點後</td><td>下午1點</td>
        </tr>
    ...
    <br>
        ...
        <div  style="height:auto; vertical-align:middle; text-align: center;">
            <h2><asp:Label ID="lbl_MOVEMENT_TYPE" runat="server"  ForeColor="Red"></asp:Label></h2>
